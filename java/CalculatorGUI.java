...
//				if(index>14&&index<20)
				// 7result = calculator.operation(Double.valueOf(s) );}
...
//		CalculatorGUIGG window1 = new CalculatorGUIGG();
	...
	// System.out.println("getNumberstxfFirstNumber " +
	// txfFirstNumber.getText());
	//
	 ...
	 * secondNumber; }
	 * 
	 * public void setTextField1(String first) { txfFirstNumber.setText(first);
	 * }
	 * 
